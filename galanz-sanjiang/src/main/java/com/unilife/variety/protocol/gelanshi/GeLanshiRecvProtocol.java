 ...
 */
public class GeLanshiRecvProtocol extends StreamProtocol {
    @Override
    public void initDefines() {

        String headString = GeLanshiModel.CMD_STX + GeLanshiModel.CMD_DEST_ADDR + GeLanshiModel.CMD_SRC_ADDR;

        addDefine(StringUtils.hexStringToLong(headString + GeLanshiModel.DATA_CMD_S), 32, 120, 0, 32, 8, UMDB.MotorAckData0);
...
//            addDefine(0, 32, 8, UMDB.MotorAckData0);
        ...
        //查询实际转速-应答
        addDefine(StringUtils.hexStringToLong(headString + GeLanshiModel.DATA_CMD_I), 32, 120, 0, 32, 8, UMDB.MotorAckData10);
//            addDefine(0, 8, 8, UMDB.MotorCmdDataSrcAddr);
//            addDefine(0, 16, 8, UMDB.MotorCmdDataDestAddr);
//            addDefine(0, 24, 8, UMDB.MotorAck);
//            addDefine(0, 32, 8, UMDB.MotorAckData0);
        ...
        //查询状态-应答
        addDefine(StringUtils.hexStringToLong(headString + GeLanshiModel.DATA_CMD_C), 32, 88, 0, 32, 8, UMDB.MotorAckData20);
//            addDefine(0, 8, 8, UMDB.MotorCmdDataSrcAddr);
//            addDefine(0, 16, 8, UMDB.MotorCmdDataDestAddr);
//            addDefine(0, 24, 8, UMDB.MotorAck);
//            addDefine(0, 32, 8, UMDB.MotorAckData0);
        ...
        //设定参数-应答
        addDefine(StringUtils.hexStringToLong(headString + GeLanshiModel.DATA_CMD_P), 32, 104, 0, 32, 8, UMDB.MotorAckData26);
//            addDefine(0, 8, 8, UMDB.MotorCmdDataSrcAddr);
//            addDefine(0, 16, 8, UMDB.MotorCmdDataDestAddr);
//            addDefine(0, 24, 8, UMDB.MotorAck);
//            addDefine(0, 32, 8, UMDB.MotorAckData0);
...
//            addDefine(0, 88, 8, UMDB.MotorAckData33);
        ...
        //查询直流母线电压、电流-应答
        addDefine(StringUtils.hexStringToLong(headString + GeLanshiModel.DATA_CMD_M), 32, 120, 0, 32, 8, UMDB.MotorAckData34);
//            addDefine(0, 8, 8, UMDB.MotorCmdDataSrcAddr);
//            addDefine(0, 16, 8, UMDB.MotorCmdDataDestAddr);
//            addDefine(0, 24, 8, UMDB.MotorAck);
//            addDefine(0, 32, 8, UMDB.MotorAckData0);
        ...
        addDefine(StringUtils.hexStringToLong(headString + GeLanshiModel.DATA_CMD_T), 32, 72, 0, 32, 8, UMDB.MotorAckData50);
