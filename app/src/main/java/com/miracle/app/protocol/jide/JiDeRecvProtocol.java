 ...
 */
public class JiDeRecvProtocol extends StreamProtocol {
    @Override
    public void initDefines() {

        //设定转速-应答
        String headString = JiDeModel.CMD_STX + JiDeModel.CMD_DEST_ADDR + JiDeModel.CMD_SRC_ADDR;
        addDefine(StringUtils.hexStringToLong(headString + JiDeModel.DATA_CMD_S), 32, 112, 0, 32, 8, UMDB.MotorAckData0);
...
//            addDefine(0, 32, 8, UMDB.MotorAckData0);
        ...
        //查询实际转速-应答
        addDefine(StringUtils.hexStringToLong(headString + JiDeModel.DATA_CMD_I), 32, 112, 0, 32, 8, UMDB.MotorAckData10);
//            addDefine(0, 8, 8, UMDB.MotorCmdDataSrcAddr);
//            addDefine(0, 16, 8, UMDB.MotorCmdDataDestAddr);
//            addDefine(0, 24, 8, UMDB.MotorAck);
//            addDefine(0, 32, 8, UMDB.MotorAckData0);
        ...
        //查询状态-应答
        addDefine(StringUtils.hexStringToLong(headString + JiDeModel.DATA_CMD_C), 32, 80, 0, 32, 8, UMDB.MotorAckData20);
//            addDefine(0, 8, 8, UMDB.MotorCmdDataSrcAddr);
//            addDefine(0, 16, 8, UMDB.MotorCmdDataDestAddr);
//            addDefine(0, 24, 8, UMDB.MotorAck);
//            addDefine(0, 32, 8, UMDB.MotorAckData0);
        ...
        //设定参数-应答
        addDefine(StringUtils.hexStringToLong(headString + JiDeModel.DATA_CMD_P), 32, 112, 0, 32, 8, UMDB.MotorAckData26);
//            addDefine(0, 8, 8, UMDB.MotorCmdDataSrcAddr);
//            addDefine(0, 16, 8, UMDB.MotorCmdDataDestAddr);
//            addDefine(0, 24, 8, UMDB.MotorAck);
//            addDefine(0, 32, 8, UMDB.MotorAckData0);
        ...
        //查询直流母线电压、电流-应答
        addDefine(StringUtils.hexStringToLong(headString + JiDeModel.DATA_CMD_M), 32, 112, 0, 32, 8, UMDB.MotorAckData34);
//            addDefine(0, 8, 8, UMDB.MotorCmdDataSrcAddr);
//            addDefine(0, 16, 8, UMDB.MotorCmdDataDestAddr);
//            addDefine(0, 24, 8, UMDB.MotorAck);
//            addDefine(0, 32, 8, UMDB.MotorAckData0);
...
//
//        //PMB指令
//        addDefine(StringUtils.hexStringToLong(headString + JiDeModel.DATA_CMD_B), 32, 112, 0, 32, 8, UMDB.MotorAckData55);
...
//        addDefine(0, 80, 8, UMDB.MotorAckData61);
//        addDefine(0, 88, 8, UMDB.MotorAckData62);
//        addDefine(0, 96, 8, UMDB.MotorAckData63);
//        addDefine(0, 104, 8, UMDB.MotorAckData64);
