...
public class WeiLiSendProtocol extends StreamProtocol {

    @Override
    public void initDefines() {

        //设定转速-应答
        String headString = WeiLiModel.CMD_STX + WeiLiModel.CMD_SRC_ADDR + WeiLiModel.CMD_DEST_ADDR;

        //设定转速
        addDefine(StringUtils.hexStringToLong(headString + WeiLiModel.DATA_CMD_S), 32, 112, 0, 32, 8, UMDB.MotorCmdData0);
...
//            addDefine(0, 40, 8, UMDB.MotorCmdDataChk);
        ...
        //查询实际转速
        addDefine(StringUtils.hexStringToLong(headString + WeiLiModel.DATA_CMD_I), 32, 48, 0, 32, 8, UMDB.MotorCmdData10);
//            addDefine(0, 8, 8, UMDB.MotorCmdDataSrcAddr);
//            addDefine(0, 16, 8, UMDB.MotorCmdDataDestAddr);
//            addDefine(0, 24, 8, UMDB.MotorCmd);
//            addDefine(0, 32, 8, UMDB.MotorCmdDataEtx);
        ...
        //查询状态
        addDefine(StringUtils.hexStringToLong(headString + WeiLiModel.DATA_CMD_C), 32, 48, 0, 32, 8, UMDB.MotorCmdData12);
//            addDefine(0, 8, 8, UMDB.MotorCmdDataSrcAddr);
//            addDefine(0, 16, 8, UMDB.MotorCmdDataDestAddr);
//            addDefine(0, 24, 8, UMDB.MotorCmd);
//            addDefine(0, 32, 8, UMDB.MotorCmdData13);
        ...
        //设定参数
        addDefine(StringUtils.hexStringToLong(headString + WeiLiModel.DATA_CMD_P), 32, 96, 0, 32, 8, UMDB.MotorCmdData15);
//            addDefine(0, 8, 8, UMDB.MotorCmdDataSrcAddr);
//            addDefine(0, 16, 8, UMDB.MotorCmdDataDestAddr);
//            addDefine(0, 24, 8, UMDB.MotorCmd);
//            addDefine(0, 32, 8, UMDB.MotorCmdData0);
...
//            addDefine(0, 56, 8, UMDB.MotorCmdDataChk);
        ...
        //查询直流母线电压、电流
        addDefine(StringUtils.hexStringToLong(headString + WeiLiModel.DATA_CMD_M), 32, 48, 0, 32, 8, UMDB.MotorCmdData23);
//            addDefine(0, 8, 8, UMDB.MotorCmdDataSrcAddr);
//            addDefine(0, 16, 8, UMDB.MotorCmdDataDestAddr);
//            addDefine(0, 24, 8, UMDB.MotorCmd);
//            addDefine(0, 32, 8, UMDB.MotorCmdDataEtx);
        ...
        //PMD指令
        addDefine(StringUtils.hexStringToLong(headString + WeiLiModel.DATA_CMD_D), 32, 48, 0, 32, 8, UMDB.MotorCmdData38);
        addDefine(0, 40, 8, UMDB.MotorCmdData39);

        //PMB指令
        addDefine(StringUtils.hexStringToLong(headString + WeiLiModel.DATA_CMD_T), 32, 48, 0, 32, 8, UMDB.MotorCmdData36);
