 ...
 */
public class GalanzSendProtocol extends StreamProtocol {
    @Override
    public void initDefines() {

        //设定转速-应答
        String headString = GalanzModel.CMD_STX + GalanzModel.CMD_SRC_ADDR + GalanzModel.CMD_DEST_ADDR;

        //设定转速
        addDefine(StringUtils.hexStringToLong(headString + GalanzModel.DATA_CMD_S), 32, 112, 0, 32, 8, UMDB.MotorCmdData0);
...
//            addDefine(0, 40, 8, UMDB.MotorCmdDataChk);
        ...
        //查询实际转速
        addDefine(StringUtils.hexStringToLong(headString + GalanzModel.DATA_CMD_I), 32, 48, 0, 32, 8, UMDB.MotorCmdData10);
//            addDefine(0, 8, 8, UMDB.MotorCmdDataSrcAddr);
//            addDefine(0, 16, 8, UMDB.MotorCmdDataDestAddr);
//            addDefine(0, 24, 8, UMDB.MotorCmd);
//            addDefine(0, 32, 8, UMDB.MotorCmdDataEtx);
        ...
        //查询状态
        addDefine(StringUtils.hexStringToLong(headString + GalanzModel.DATA_CMD_C), 32, 48, 0, 32, 8, UMDB.MotorCmdData12);
//            addDefine(0, 8, 8, UMDB.MotorCmdDataSrcAddr);
//            addDefine(0, 16, 8, UMDB.MotorCmdDataDestAddr);
//            addDefine(0, 24, 8, UMDB.MotorCmd);
//            addDefine(0, 32, 8, UMDB.MotorCmdData13);
        ...
        //设定参数
        addDefine(StringUtils.hexStringToLong(headString + GalanzModel.DATA_CMD_P), 32, 104, 0, 32, 8, UMDB.MotorCmdData15);
//            addDefine(0, 8, 8, UMDB.MotorCmdDataSrcAddr);
//            addDefine(0, 16, 8, UMDB.MotorCmdDataDestAddr);
//            addDefine(0, 24, 8, UMDB.MotorCmd);
//            addDefine(0, 32, 8, UMDB.MotorCmdData0);
        ...
        //查询直流母线电压、电流
        addDefine(StringUtils.hexStringToLong(headString + GalanzModel.DATA_CMD_M), 32, 48, 0, 32, 8, UMDB.MotorCmdData23);
//            addDefine(0, 8, 8, UMDB.MotorCmdDataSrcAddr);
//            addDefine(0, 16, 8, UMDB.MotorCmdDataDestAddr);
//            addDefine(0, 24, 8, UMDB.MotorCmd);
//            addDefine(0, 32, 8, UMDB.MotorCmdDataEtx);
         ...
         * 查询温度
         */
        addDefine(StringUtils.hexStringToLong(headString + GalanzModel.DATA_CMD_T), 32, 48, 0, 32, 8, UMDB.MotorCmdData28);
//            addDefine(0, 8, 8, UMDB.MotorCmdDataSrcAddr);
//            addDefine(0, 16, 8, UMDB.MotorCmdDataDestAddr);
//            addDefine(0, 24, 8, UMDB.MotorCmd);
//            addDefine(0, 32, 8, UMDB.MotorCmdData13);
