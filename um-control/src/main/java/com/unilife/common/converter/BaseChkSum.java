 ...
 */
public class BaseChkSum {

    public static int chksumXOR(int[] data, int sz)
    {
        int chksum = 0;
    ...
    public static int chksumSum(int[] data, int sz)
    {
        int chksum = 0;
    ...
    public static int chksumCRC16(int[] bdata, int offset, int length) {
        int[] table = {
        ...
        for (int i=offset; i<length; i++) {
            crc = (crc >>> 8) ^ table[(crc ^ bdata[i]) & 0xff];
        }

        return (crc);
    }

    public static int chksumCRC8(int[] bdata, int offset, int length) {
        int[] table = {
